...
namespace NGANHANG_APP
{
    public partial class FormNhanVien : DevExpress.XtraEditors.XtraForm
    {
        ...
        */
        ...
        {
          /*  // TODO: This line of code loads data into the 'nGANHANGDataSet2.NhanVien' table. You can move, or remove it, as needed.
            this.nhanVienTableAdapter.Fill(this.NGANHANGDATASET.NhanVien);
            // TODO: This line of code loads data into the 'nGANHANGDataSet2.ChiNhanh' table. You can move, or remove it, as needed.
        ...
        private void nhanVienBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
          ...
          /*  this.nhanVienTableAdapter.Update(this.NGANHANGDATASET);*/
       ...
       *********************************************************************/
        ...
        private void btnXoa_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            // khong cho xoa nguoi dang dang nhap ke ca nguoi do khong co tao GD,chuyen rut
...
*/
           ...
           ///
            ...
            string cauTruyVanHoanTac =
                string.Format("INSERT INTO DBO.NHANVIEN( MANV,HO,TEN,CMND,DIACHI,PHAI,SDT,MACN,TrangthaiXoa)" +
            "VALUES('{0}','{1}','{2}','{3}','{4}', '{5}','{6}','{7}',{8})", txtMaNV.Text, txtHo.Text, txtTen.Text,txtCMND.Text, txtDiaChi.Text,txtPhai.Text,txtSDT.Text, txtMaCN.Text.Trim(),cbTrangThaiXoa.Text);
        ...
        private void btnGhi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            int trangThaixoa = (cbTrangThaiXoa.Checked == true) ? 1 : 0;
